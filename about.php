...
<body onload="createCaptcha();">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-11 offset-lg-1 pe-lg-0">
                        <div class="aboutItemInner">
                            <div class="imgAboutInner">
                                <picture>
                                    <source srcset="images/aurelia.webp" type="image/type" />
                                    <img src="images/aurelia.jpg" />
                                </picture>
                            </div>
                        ...
                        <div class="aboutItemInner greyBg">
                            <div class="rightInnerAboutLeft order-2 order-lg-1">
                                ...
                                <div class="moreContent" style="display:block">
                                    ...
                                    <p>With her unparalleled expertise, strategic acumen, and commitment to excellence, Ragini Shah continues to leave an indelible mark on the legal profession, shaping the future of Intellectual Property and Transactions with her visionary leadership and unwavering dedication.</p>
                                </div>
                                <a href="javascript:void();" onclick="toggleContent();" class="text-white readContent text-underline mt-3 d-inline-block">Read Less</a>
                                <div>
                                    <a href="/" class="btnWhite">Book an appointment</a>
                                </div>
                            </div>
    ...
    <script>
        function toggleContent() {
            const moreText = document.querySelector('.moreContent');
            const btnMore = document.querySelector('.readContent');
