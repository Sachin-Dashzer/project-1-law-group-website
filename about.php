                        ...
                        <div class="aboutItemInner greyBg">
                            <div class="rightInnerAboutLeft order-2 order-lg-1">
                                ...
                                <div class="moreContent" style="display:none">
                                    ...
                                    <p>With her unparalleled expertise, strategic acumen, and commitment to excellence, Ms Shah continues to leave an indelible mark on the legal profession, shaping the future of Intellectual Property and Transactions with her visionary leadership and unwavering dedication.</p>
                                </div>
                                <a href="javascript:void();" onclick="toggleContent();" class="text-white readContent text-underline mt-3 d-inline-block">Read More</a>
                                <div>
                                    <a href="/" class="btnWhite">Book an appointment</a>
                                </div>
                            </div>
